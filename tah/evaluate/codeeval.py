...
# Model instructions for code evaluation
INSTRUCTION_PREFIX = "Please provide a self-contained Python script that solves the following problem in a markdown code block:"
INSTRUCTION_PREFIX_REASONING = "Please think step by step and then provide a self-contained Python script that solves the following problem in a markdown code block:"
...
def make_raw_chat_prompt_for_code_evaluation(
    task_prompt: str,
    reasoning: bool,
    tokenizer,
) -> str:
    ...
    task_prompt = f"""\
{INSTRUCTION_PREFIX_REASONING if reasoning else INSTRUCTION_PREFIX}
```
{task_prompt.strip()}
```
"""
            ...
            def stucking_checker():
                while remainings:
                    ...
                    if last_size != len(remainings) or len(remainings) == 0:
                        continue
                    # Potential stucking
                    warn("No samples had finished testing in the last 100s")
